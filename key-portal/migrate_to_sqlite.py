...
# Historical default for older local CLIProxyAPI builds. v7.1.29 no longer
# exposes this snapshot endpoint; current production usage sync comes from
# LiteLLM PG / Key Portal caches instead.
MANAGEMENT_API_URL = os.environ.get("LEGACY_MANAGEMENT_USAGE_URL", "")
